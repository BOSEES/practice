...
// source: practice/mint/mint.proto
...
func init() {
	proto.RegisterType((*Minter)(nil), "practice.mint.Minter")
	proto.RegisterType((*Params)(nil), "practice.mint.Params")
}

func init() { proto.RegisterFile("practice/mint/mint.proto", fileDescriptor_e0bccce3b583aa44) }
