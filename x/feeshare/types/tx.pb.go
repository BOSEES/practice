...
// source: practice/feeshare/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterFeeShare)(nil), "practice.feeshare.v1.MsgRegisterFeeShare")
	proto.RegisterType((*MsgRegisterFeeShareResponse)(nil), "practice.feeshare.v1.MsgRegisterFeeShareResponse")
	proto.RegisterType((*MsgUpdateFeeShare)(nil), "practice.feeshare.v1.MsgUpdateFeeShare")
	proto.RegisterType((*MsgUpdateFeeShareResponse)(nil), "practice.feeshare.v1.MsgUpdateFeeShareResponse")
	proto.RegisterType((*MsgCancelFeeShare)(nil), "practice.feeshare.v1.MsgCancelFeeShare")
	proto.RegisterType((*MsgCancelFeeShareResponse)(nil), "practice.feeshare.v1.MsgCancelFeeShareResponse")
}

func init() { proto.RegisterFile("practice/feeshare/v1/tx.proto", fileDescriptor_db5ab2575863a062) }
...
func (c *msgClient) RegisterFeeShare(ctx context.Context, in *MsgRegisterFeeShare, opts ...grpc.CallOption) (*MsgRegisterFeeShareResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/practice.feeshare.v1.Msg/RegisterFeeShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFeeShare(ctx context.Context, in *MsgUpdateFeeShare, opts ...grpc.CallOption) (*MsgUpdateFeeShareResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/practice.feeshare.v1.Msg/UpdateFeeShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelFeeShare(ctx context.Context, in *MsgCancelFeeShare, opts ...grpc.CallOption) (*MsgCancelFeeShareResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/practice.feeshare.v1.Msg/CancelFeeShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterFeeShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/practice.feeshare.v1.Msg/RegisterFeeShare",
	}
...
func _Msg_UpdateFeeShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/practice.feeshare.v1.Msg/UpdateFeeShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelFeeShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/practice.feeshare.v1.Msg/CancelFeeShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "practice.feeshare.v1.Msg",
	...
	Metadata: "practice/feeshare/v1/tx.proto",
}
