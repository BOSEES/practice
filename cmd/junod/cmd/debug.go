...
// get cmd to convert any bech32 address to a practice prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the practice prefix",
		Long: `Convert any bech32 string to the practice prefix
Especially useful for converting cosmos addresses to practice addresses
Example:
	practiced bech32-convert practice1ey69r37gfxvxg62sh4r0ktpuc46pzjrm5cxnjg -p osmo
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "practice", "Bech32 Prefix to encode to")
