...
import (
	...
	"github.com/BOSEES/practice/v12/docs"
	...
	"github.com/BOSEES/practice/v12/app/keepers"
	encparams "github.com/BOSEES/practice/v12/app/params"
	upgrades "github.com/BOSEES/practice/v12/app/upgrades"
	v10 "github.com/BOSEES/practice/v12/app/upgrades/v10"
	v11 "github.com/BOSEES/practice/v12/app/upgrades/v11"
	v12 "github.com/BOSEES/practice/v12/app/upgrades/v12"
)

const (
	AccountAddressPrefix = "practice"
	Name                 = "practice"
)
...
// any overrides above
var (
	// DefaultNodeHome default home directories for practice
...
func GetWasmOpts(appOpts servertypes.AppOptions) []wasm.Option {
	...
	wasmOpts = append(wasmOpts, wasmkeeper.WithGasRegister(NewpracticeWasmGasRegister()))
...
// New returns a reference to an initialized practice.
func New(
	logger log.Logger,
	db dbm.DB,
...
// AppCodec returns practice's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
...
// InterfaceRegistry returns practice's InterfaceRegistry
