...
// Returns "upractice" if the chainID starts with "practice-" (ex: practice-1 or practice-t1 for local)
// else its the uni testnet
func GetChainsDenomToken(chainID string) string {
	if strings.HasPrefix(chainID, "practice-") {
		return "upractice"
	}
	return "upracticex"
}

// CreateV12UpgradeHandler makes an upgrade handler for v12 of practice
func CreateV12UpgradeHandler(
	...
	return func(ctx sdk.Context, _ upgradetypes.Plan, vm module.VersionMap) (module.VersionMap, error) {
		...
		// ICA - https://github.com/BOSEES/practice/blob/integrate_ica_changes/app/app.go#L846-L885
